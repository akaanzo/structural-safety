...
\begin{figure}
	...
	\includegraphics[width=.5\textwidth]{../../export/img/bendingMomentComp}}
	\subfloat[\emph{Zoom in}]{\includegraphics[width=.5\textwidth]{../../export/img/bendingMomentComp_zoom}}
...
\resizebox{\textwidth}{!}{
 ...
 \toprule
   ...
   &Esterno ($\times 2.10$) &$6.72$ &$4.65$ &$8.40$ &\begin{tabular}{c}
															$5.06$ (min)\\$10.30$ (max)
                                                       \end{tabular} &0.30\\
	\multirow{2}{*}{$P17 - VS$}&Interno ($\times 2.50)$&$8.00$&$11.55$&$7.50$\\
